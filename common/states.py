...
class GlobalStates:
    ...
    CUSTOM_SUBMODE_EMERGENCY_GPS = 92
    CUSTOM_SUBMODE_EMERGENCY_COMM = 93
    CUSTOM_SUBMODE_EMERGENCY_FCON = 94
    ...
    CUSTOM_SUBMODE_NAMES = {
        ...
        CUSTOM_SUBMODE_EMERGENCY_GPS: 'EMERGENCY_GPS',
        CUSTOM_SUBMODE_EMERGENCY_COMM: 'EMERGENCY_COMM',
        CUSTOM_SUBMODE_EMERGENCY_FCON: 'EMERGENCY_FCON',
    ...
    CUSTOM_SUBMODES = [
        ...
        CUSTOM_SUBMODE_EMERGENCY_GPS,
        CUSTOM_SUBMODE_EMERGENCY_COMM,
        CUSTOM_SUBMODE_EMERGENCY_FCON,
    ...
    ALLOWED_CUSTOM_MODES = {
        ...
        CUSTOM_SUBMODE_EMERGENCY_GPS: [CUSTOM_MODE_EMERGENCY],
        CUSTOM_SUBMODE_EMERGENCY_COMM: [CUSTOM_MODE_EMERGENCY],
        CUSTOM_SUBMODE_EMERGENCY_FCON: [CUSTOM_MODE_EMERGENCY],
    ...
    ALLOWED_MODES = {
        ...
        CUSTOM_SUBMODE_EMERGENCY_GPS: [m.MAV_MODE_GUIDED_ARMED, m.MAV_MODE_AUTO_ARMED],
        CUSTOM_SUBMODE_EMERGENCY_COMM: [m.MAV_MODE_GUIDED_ARMED, m.MAV_MODE_AUTO_ARMED],
        CUSTOM_SUBMODE_EMERGENCY_FCON: [m.MAV_MODE_GUIDED_ARMED, m.MAV_MODE_AUTO_ARMED],
    ...
    ALLOWED_STATES = {
        ...
        CUSTOM_SUBMODE_EMERGENCY_GPS: [m.MAV_STATE_CRITICAL, m.MAV_STATE_EMERGENCY],
        CUSTOM_SUBMODE_EMERGENCY_COMM: [m.MAV_STATE_CRITICAL, m.MAV_STATE_EMERGENCY],
        CUSTOM_SUBMODE_EMERGENCY_FCON: [m.MAV_STATE_CRITICAL, m.MAV_STATE_EMERGENCY],
